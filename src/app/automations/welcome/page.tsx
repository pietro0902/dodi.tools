...
export default function WelcomeAutomationPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      setSubject(settingsData.welcome.subject);
      setPreheader(settingsData.welcome.preheader || "");
      setBlocks(settingsData.welcome.blocks || []);
      setBgColor(settingsData.welcome.bgColor || "#f9fafb");
      setBtnColor(settingsData.welcome.btnColor || "#111827");
      setContainerColor(settingsData.welcome.containerColor || "#ffffff");
      setTextColor(settingsData.welcome.textColor || "#374151");
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      setSettings(updated);
      app.toast.show("Email di benvenuto salvata");
    } catch (err) {
      app.toast.show(
  ...
  if (loading) {
    return (
      <Page title="Email di Benvenuto" backAction={{ onAction: () => router.push("/automations") }}>
        <Layout>
          <Layout.Section>
            <Card>
