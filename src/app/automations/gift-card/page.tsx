...
export default function GiftCardAutomationPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      setSubject(settingsData.giftCard.subject);
      setPreheader(settingsData.giftCard.preheader || "");
      setBlocks(settingsData.giftCard.blocks || []);
      setBgColor(settingsData.giftCard.bgColor || "#f9fafb");
      setBtnColor(settingsData.giftCard.btnColor || "#111827");
      setContainerColor(settingsData.giftCard.containerColor || "#ffffff");
      setTextColor(settingsData.giftCard.textColor || "#374151");
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      setSettings(updated);
      app.toast.show("Email gift card salvata");
    } catch (err) {
      app.toast.show(
  ...
  }, [app, settings, subject, preheader, blocks, bgColor, btnColor, containerColor, textColor]);
  ...
  if (loading) {
    return (
      <Page title="Gift Card Acquistata" backAction={{ onAction: () => router.push("/automations") }}>
        <Layout>
          <Layout.Section>
            <Card>
